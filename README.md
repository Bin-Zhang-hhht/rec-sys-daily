...
├── .github/workflows/      # daily、site-only、verify
...
3. 在 GitHub Pages 中启用 GitHub Actions 作为发布源，然后手动触发 `RecSys Daily` 首次运行。
...
完整命令、各阶段 artifact 契约和失败语义请见[架构文档](docs/architecture.md#8-本地-docker-验证)。

## 技术栈

Python 3.12 · Docker · DeepSeek OpenAI-compatible Responses API · MinerU · FastEmbed · Astro · TypeScript · Tailwind CSS 4 · Pagefind Extended · ECharts · GitHub Actions · GitHub Pages
