...
def _write_config(root: Path) -> None:
    ...
    _write_yaml(root / "config/settings.yaml", {
        ...
        "limits": {"http_concurrency": 2, "nvidia_hard_rpm": 40, "nvidia_target_rpm": 30, "nvidia_parallel_workers": 2, "nvidia_concurrency_per_worker": 1, "nvidia_min_interval_seconds_per_worker": 4, "arxiv_min_interval_seconds": 3, "request_timeout_seconds": 45, "retry_attempts": 3, "max_papers_per_run": 100, "max_blogs_per_run": 50, "deep_reading_candidates_per_type": 16, "pdf_download_concurrency": 1, "blog_download_concurrency_per_domain": 1, "blog_min_interval_seconds_per_domain": 2, "max_blog_html_bytes": 5_242_880},
